...
@section('title', 'Admin - Add New Wine')
    ...
    <div class="col-md-10">
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0"><i class="fas fa-plus me-2"></i>Add New Wine</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.dataset.store') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control @error('vintage') is-invalid @enderror" 
                                id="vintage" name="vintage" value="{{ old('vintage') }}">
                            @error('vintage')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control @error('grape_variety') is-invalid @enderror" 
                                id="grape_variety" name="grape_variety" value="{{ old('grape_variety') }}">
                            @error('grape_variety')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control @error('flavor_profile') is-invalid @enderror" 
                                id="flavor_profile" name="flavor_profile" rows="3">{{ old('flavor_profile') }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control @error('food_pairings') is-invalid @enderror" 
                                id="food_pairings" name="food_pairings" rows="3">{{ old('food_pairings') }}</textarea>
                            @error('food_pairings')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-8">
                            ...
                            <textarea class="form-control @error('tasting_notes') is-invalid @enderror" 
                                id="tasting_notes" name="tasting_notes" rows="4">{{ old('tasting_notes') }}</textarea>
                            @error('tasting_notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('alcohol_content') is-invalid @enderror" 
                                    id="alcohol_content" name="alcohol_content" value="{{ old('alcohol_content') }}">
                    ...
                    <div class="text-center mt-4">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-2"></i>Add Wine
                        </button>
