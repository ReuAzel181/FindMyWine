    ...
    <div class="col-md-12 mb-4">
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0"><i class="fas fa-database me-2"></i>Wine Dataset Management</h4>
            </div>
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-grid gap-2">
                                    <a href="{{ route('admin.dataset.import.form') }}" class="btn btn-primary">
                                        <i class="fas fa-file-import me-2"></i>Import Wines from CSV
                                    </a>
                                    <a href="{{ route('admin.dataset.export') }}" class="btn btn-outline-primary">
                                        <i class="fas fa-file-export me-2"></i>Export Wines to CSV
                                    </a>
                                    <a href="{{ route('admin.dataset.list') }}" class="btn btn-outline-primary">
                ...
                <div class="text-center mt-4">
                    <a href="{{ route('wine.index') }}" class="btn btn-outline-secondary">
